...
class SetpointPosition:
    ...
    def navigate(self):
        ...
        while not rospy.is_shutdown():
            ...
            print repr(('X ',self.x,'Y ',self.y,'Z ',self.z))
            #print repr(('topicX ',self.topicX,'topicY ',self.topicY,'topicZ ',self.topicZ))
            ...
            '''
            print repr(('published pose', msg.pose.position.x ,' ', msg.pose.position.y ,' ', msg.pose.position.z))
            print repr(('orientation',msg.pose.orientation))
            '''
            rate.sleep()
 
    def set(self, x, y, z, delay=0, wait=True):
        print "set command start"        
        self.done = False
        '''       
        self.x = self.topicX + x
        self.y = self.topicY + y
        self.z = self.topicZ + z
       '''
        self.x =  x
        self.y =  y
        self.z =  z
    ...
    def reached(self, topic):
        ...
        self.topicX =topic.pose.position.x
        self.topicY =topic.pose.position.y
        self.topicZ =topic.pose.position.z
